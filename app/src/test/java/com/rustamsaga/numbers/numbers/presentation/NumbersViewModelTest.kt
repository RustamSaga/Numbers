...
import com.rustamsaga.numbers.main.presentation.Screen
import com.rustamsaga.numbers.numbers.domain.NumberFact
import com.rustamsaga.numbers.numbers.domain.NumberUiMapper
import com.rustamsaga.numbers.numbers.domain.NumbersInteractor
...
class NumbersViewModelTest : BaseTest() {
    ...
    /**
     * Превоначальный тест
     * При запуске получить данные и показать их
     * затем попытаться получить некоторые данные успешно
     * затем повторно инициализировать и проверить результат
     */
    @Test
